// ─── BACKEND BASE URL ────────────────────────────────────────────────────────
// In local frontend development, Vite proxies /v1/* to localhost:8000.
// In Docker/Kubernetes, the Node/Express app serves the frontend and handles /v1/*.
// Leave this empty so the frontend always uses same-origin /v1 routes.
